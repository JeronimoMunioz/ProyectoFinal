...
function sectorCompraProductos() {
    let miNodoProductos1 = document.createElement('div')
    miNodoProductos1.classList.add('col-6')
    miNodoProductos1.innerHTML = `
        <div class='shopping-cart-header'>
            <h5>Producto</h5>Productos
        </div>
    `

    let miNodoProductos2 = document.createElement('div')
    miNodoProductos2.classList.add('col-2')
    miNodoProductos2.innerHTML = `
        <div class='shopping-cart-header'>
            <h5 class='text-truncate'>Precio</h5>
        </div>
    `

    let miNodoProductos3 = document.createElement('div')
    miNodoProductos3.classList.add('col-4')
    miNodoProductos3.innerHTML = `
        <div class='shopping-cart-header'>
            <h5>Cantidad</h5>
        </div>
    `

    sectorCompraDeProductos.appendChild(miNodoProductos1)
    sectorCompraDeProductos.appendChild(miNodoProductos2)
    sectorCompraDeProductos.appendChild(miNodoProductos3)
}
sectorCompraProductos()
        ...
        carrito.forEach(producto => {
           ...
           <div class="col-4">
               <div
                   ...
                   x${producto.cantidad}
                   <button class="btn btn-danger buttonDelete" onclick='borradoDeProducto(${carrito.indexOf(producto)})' type="button">X</button>
               </div>
           </div>
       </div>
            `
...
function sumadorDePrecios() {
    ...
    carrito.forEach(mueble => {
        const precio = Number(mueble.precio)
        const cantidad = Number(mueble.cantidad)
